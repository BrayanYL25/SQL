...
Insert Into Curso(IdCurso,IdTarifa,NomCurso) Values('C006','C','Dise�o de Sistemas con UML')
...
Insert Into Curso(IdCurso,IdTarifa,NomCurso) Values('C010','C','SQL Server II - Programaci�n')
