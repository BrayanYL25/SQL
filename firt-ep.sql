...
('Estefano', 'Iba�ez', 'Santiago de Surco', '9831202309')

-- 10. En la Tabla VENDEDOR Cambiar el Tel�fono del segundo registro.

UPDATE VENDEDOR
SET TelefVend = '21333990122'
WHERE IdVendedor = 2

-- 11. Eliminar el �ltimo registro de la Tabla VENDEDOR.
...
-- Adem�s, que el stock de los productos sea mayor o igual a 20 unidades y menor o igual a 60 unidades.
...
-- 14. En Northwind. Presentar una lista de Clientes cuyo representante tenga que ver con el �rea de Marketing o el �rea de Ventas.
...
-- 15. En Northwind. Presentar una lista de los cuatro Pa�ses con mayor cantidad de Proveedores.
SELECT TOP 4 Country "Pais", COUNT(Country) "Proveedores" FROM Suppliers
GROUP BY Country
ORDER BY 2 DESC

-- 16. En Northwind presentar una lista de pedidos que se hayan entregado fuera del l�mite 
-- programado para la entrega. Mostrar el c�digo del transportista que se encarg� de llevar el pedido,
-- la fecha del pedido, la fecha requerida para se entregue el pedido la diferencia en d�as que se excedi� la entrega.
SELECT 
